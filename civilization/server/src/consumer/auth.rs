...
pub async fn handle_account_public_event(
    ...
    repository: CivilizationRepository,
    admin_repository: CivilizationAdminRepository,
    ...
    let group_name = "mono_civilization_event";
    ...
    loop {
            ...
            && current_app_id == app_id.to_string()
        {
            ...
            if let Some(time) = admin_model.state().dto().time() {
