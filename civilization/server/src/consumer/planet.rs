...
pub async fn handle_planet_public_event(
    ...
    account_repository: CivilizationRepository,
) -> anyhow::Result<()> {
    ...
    let group_name = "mono_civilization_add_planet";
    ...
    loop {
        ...
        if let Some(old_account_id) = old_account_id {
            account_repository
                .add_command(
                    ...
                    CivilizationCommand::RemoveWorld(event.stream_id().to_string()),
                    Some(&metadata),
                )
                .await
        ...
        account_repository
            .add_command(
                ...
                CivilizationCommand::AddWorld(Component {
                    endpoint,
